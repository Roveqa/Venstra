 ...
 * - Line active: border-bottom 1px stroke-emphasis, no bg.
...
export function TabsList({ className, tabsStyle = "fill", ...props }: TabsListProps) {
  return <RadixTabs.List className={clsx(styles.list, className)} data-style={tabsStyle} {...props} />;
}
